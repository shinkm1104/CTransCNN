...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/userHome/userhome4/kyoungmin/code/Xray/CTransCNN/save/002/train_val_list.txt',
        classes=
    ...
    test=dict(
        ...
        data_prefix='/userHome/userhome4/kyoungmin/code/Xray/dataset/',
        ann_file=
        '/userHome/userhome4/kyoungmin/code/Xray/CTransCNN/save/002/test_list.txt',
        classes=
        '/userHome/userhome4/kyoungmin/code/Xray/dataset/add72_chest14_classes.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
log_level = 'INFO'
load_from = None
resume_from = '/userHome/userhome4/kyoungmin/code/Xray/CTransCNN/save/002/epoch_2.pth'
workflow = [('train', 1)]
work_dir = '/userHome/userhome4/kyoungmin/code/Xray/CTransCNN/save/002'
gpu_ids = [0]
